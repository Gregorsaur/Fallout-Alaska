...
SWEP.Category				= "Fallout | Weapons (5mm Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("acshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_assaultcarbine.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_assaultcarbine.mdl" -- Weapon world model path
...
--Vector(7.837, 0.982, -1.448), angle = Angle(-8.379, 0.016, 180) carb
