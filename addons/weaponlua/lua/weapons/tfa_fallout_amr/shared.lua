...
SWEP.Gun 					= ("tfa_fallout_amr") -- must be the name of your swep but NO CAPITALS!
SWEP.Base					= "tfa_3dscoped_base"
SWEP.Category 				= "TFA Fallout Weapons" --Category where you will find your weapons
SWEP.Author					= "Nikkerio"
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions			= "Takes 50mg Ammunition"
SWEP.PrintName				= "Anti-Material Rifle (50MG)"		-- Weapon name (Shown on HUD)	
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_fnv_amr.single") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel				= "models/weapons/c_fnv_amr_tfa.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel	= "models/halokiller38/fallout/weapons/sniperrifles/antimaterielrifle.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.306, -0.5, 0)
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "weapon", rel = "", pos = Vector(0.6, -3.95, -0.005), angle = Angle(180, 0, -90), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
