...
language.Add("tool.statue.unfreeze", "Unfreeze on Statue")
end
...
function TOOL.BuildCPanel( CPanel )
	CPanel:AddControl( "Header", { Text = "#tool.statue.name", Description = "#tool.statue.desc" } )
	CPanel:AddControl( "CheckBox", { Label = "#tool.statue.unfreeze", Command = "statue_unfreeze"}  )
end