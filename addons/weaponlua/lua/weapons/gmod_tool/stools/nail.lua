...
language.Add("tool.nail.forcelimit", "Force Limit")
language.Add("tool.nail.desc2", "Set the force limit to 0 to not break.")
end
...
function TOOL.BuildCPanel( CPanel )
	CPanel:AddControl( "Header", { Text = "#tool.nail.name", Description = "#tool.nail.desc2" }  )
	CPanel:AddControl( "Slider", { Label = "#tool.nail.forcelimit", Type = "Float", Command = "nail_forcelimit", Min = "0", Max = "1000" }  )
end
