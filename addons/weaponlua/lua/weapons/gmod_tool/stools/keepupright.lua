...
language.Add("tool.keepupright.angularlimit", "Angular Limit")
end
...
function TOOL.BuildCPanel( panel )	
	panel:AddControl( "Header", { Text = "#tool.keepupright.name", Description	= "#tool.keepupright.desc" }  )
	panel:AddControl( "Slider", { Label = "#tool.keepupright.angularlimit", Type = "Integer", Command = "keepupright_angularlimit", Min = "0", Max = "100000" }  )
end