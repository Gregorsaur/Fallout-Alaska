...
if ( CLIENT ) then
	...
	language.Add("tool.magnetise.0", "Left click to magnetise a prop")
	
	language.Add("tool.magnetise.strength", "Strength")
	language.Add("tool.magnetise.maxobjects", "Max Objects")
	
	language.Add("tool.magnetise.alwayson", "Always On")
	language.Add("tool.magnetise.toggleon", "Toggle On")
	language.Add("tool.magnetise.nopull", "No Pull")
	language.Add("tool.magnetise.allowrotation", "Allow Rotation")
	language.Add("tool.magnetise.group", "Key")
...
function TOOL.BuildCPanel( CPanel )
	...
	CPanel:AddControl( "Header", { Text = "#tool.magnetise.name", Description = "#tool.magnetise" } )
	CPanel:AddControl( "Numpad", { Label = "#tool.magnetise.group", Command = "magnetise_group"} )
	CPanel:AddControl( "Slider", { Label = "#tool.magnetise.strength", Command = "magnetise_strength", Type = "Integer", Min = 0, Max = 50000} )
	CPanel:AddControl( "Slider", { Label = "#tool.magnetise.maxobjects", Command = "magnetise_maxobjects", Type = "Float", Min = 0, Max = 30} )
	CPanel:AddControl( "CheckBox", { Label = "#tool.magnetise.nopull", Command = "magnetise_nopull"}  )
	CPanel:AddControl( "CheckBox", { Label = "#tool.magnetise.allowrotation", Command = "magnetise_allowrotation"}  )
	CPanel:AddControl( "CheckBox", { Label = "#tool.magnetise.alwayson", Command = "magnetise_alwayson"}  )
	CPanel:AddControl( "CheckBox", { Label = "#tool.magnetise.toggleon", Command = "magnetise_toggleon"}  )
