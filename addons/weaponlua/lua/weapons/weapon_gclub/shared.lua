...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/gclub.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(3.809, -0.551, -29.244), angle = Angle(0.3, -74.137, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/gclub.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.121, 1.197, 31.254), angle = Angle(180, -89.548, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.PrintName		= "Nephi's Golf Club"	 
