...
SWEP.PrintName				= "Institute Rifle"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("fo4instituterif_nope.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 66 -- Damage, in standard damage points.
...
--Firing Cone Related
SWEP.Primary.Spread = .029 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .005 -- Ironsight accuracy, should be the same for shotguns
--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 2.4--How far the spread can expand when you shoot. Example val: 2.5
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/falloutweapons/c_fo4instituterif_nope.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/falloutweapons/w_fo4instituterif_nope.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(-1.241, 0, -0.671)
SWEP.RunSightsAng = Vector(-8.843, 7.706, -1.341)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.619, 0, -0.191)
SWEP.IronSightsAng = Vector(-1.173, -2.041, 1.547)
--[[INSPECTION]]--
...
SWEP.MuzzleFlashEffect = "fo4_energy_muz" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
--Tracer Stuff
SWEP.TracerName 		= "fo4_energy_tra" 	--Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
