...
SWEP.PrintName				= "Recharger Pistol"      -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound             = Sound("weapons/fallout_new_vegas/recharger_pistol/Wpn_laserdefender_fire_2d.wav")            -- This is the sound of the weapon, when you shoot.
...
SWEP.IronSightsPos     = Vector(-2.11, 0, 0.08)
...
SWEP.ViewModel				= "models/Fallout/fonv/rechargerpistol/c_fallout_recharger_pistol.mdl"	-- Weapon view model
...
SWEP.WorldModel				= "models/Fallout/fonv/rechargerpistol/w_fallout_recharger_pistol.mdl"	-- Weapon view model
