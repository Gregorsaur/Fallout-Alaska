...
SWEP.Category				= "Fallout" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.VMAng = Vector(0,0.5,0) --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
...
SWEP.IronSightsPos = Vector(-2.723, -1.976, 1.246)
SWEP.IronSightsAng = Vector(0.125, -1.58, -1.262)

SWEP.IronSightsPos_Kobra = Vector(-2.615, -2, 0.168)
SWEP.IronSightsAng_Kobra = Vector(0.08, -0.01, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.615, -2, -0.071)
SWEP.IronSightsAng_EOTech = Vector(0.08, -0.01, 0)

SWEP.IronSightsPos_RDS = Vector(-2.616, -3.5, -0.073)
SWEP.IronSightsAng_RDS = Vector(0.08, -0.01, 0)
...
SWEP.VElements = {
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
...
SWEP.Attachments = {
	...
	[9] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds" }, order = 2 },
