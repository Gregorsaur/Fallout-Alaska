...
SWEP.VElements = {
	["v_leadpipe"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/leadpipe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 2.596), angle = Angle(1.169, -94.676, 180), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["w_leadpipe"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/leadpipe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 1.5), angle = Angle(5.843, -73.637, 174.156), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}