...
SWEP.PrintName				= "Hunting Revolver"	  -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound                 = Sound("TFA_Fallout.Hunting_Revolver.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Ammo            = "45-70Govt"     -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
SWEP.IronSightsPos = Vector(-1.725, 0, -0.8)
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_hunting_revolver.mdl" -- Viewmodel path
...
SWEP.WorldModel		= "models/weapons/tfa_fallout/w_fallout_hunting_revolver.mdl" -- Weapon world model path
...
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "j_gun", rel = "", pos = Vector(0.55, 0.03, 5.95), angle = Angle(0, -180, 0), size = Vector(0.35, 0.35, 0.35), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false }
}
