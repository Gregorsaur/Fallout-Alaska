...
SWEP.ParrySound = Sound("beams/beamstart5.wav")
...
//This if shot the bullets
	...
	if ( tr.Hit ) then
		...
		bullet.Damage = math.random( 225, 250 )
...
function SWEP:PrimaryAttack()
	...
	if self:Ammo1() < 5 then return end
						...
						self.Weapon:EmitSound("ambient/gas/cannister_loop.wav")
...
self.NextSecondaryAttack = CurTime() + 2
			...
			self.Owner:ViewPunch(Angle(-60,0,0))
...
SWEP.VElements = {
	["v_supersledge"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/rockethammer.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-2.901, 3.5, 0.899), angle = Angle(82.986, -5.844, -73.637), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["w_supersledge"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/rockethammer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.557, 2.596), angle = Angle(180, 64.286, 1.169), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}