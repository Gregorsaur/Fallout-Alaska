...
SWEP.Gun = ("tfa_fallout_sniper") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Purpose				= ""
SWEP.Instructions			= ""
SWEP.PrintName				= "Sniper Rifle (.308 rounds)"		-- Weapon name (Shown on HUD)	
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("Wpn_huntingrifle_fire_2d_03.ogg") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 45 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = false -- Automatic/Semi Auto
SWEP.Primary.RPM = 115 -- This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel				= "models/weapons/hub/sniperrifle/c_sniperrifle.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel	= "models/weapons/w_fnv_amr_tfa.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-6.381, -8.844, 1.657)
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Sniper", rel = "", pos = Vector(2.079, 3.635, 0.425), angle = Angle(0, -106.364, -90), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/hub/sniperrifle/sniperrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.375, 1.557, 4.675), angle = Angle(0, 92.337, -170), size = Vector(1.049, 1.049, 1.049), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
