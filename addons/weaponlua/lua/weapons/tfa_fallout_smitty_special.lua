...
SWEP.PrintName				= "Smitty Special" -- Weapon name (Shown on HUD)	
...
SWEP.VMPos          = Vector(-3.5, -8.5, -1)
SWEP.VMAng          = Vector(5, 0, 0)
SWEP.UseHands				= true
SWEP.ViewModelFlip			= false
SWEP.ViewModel				= "models/Fallout/fonv/plasmacaster/c_fallout_smitty_special.mdl"	-- Weapon view model
SWEP.WorldModel 			= "models/Fallout/fonv/plasmacaster/w_fallout_smitty_special.mdl"	-- Weapon world model
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(7.2, 12, 0) },
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(1.25, 0.72, 3.5), angle = Angle(0, 0, 0) },
}	

SWEP.Primary.Sound		    = Sound("weapons/fallout_new_vegas/plasma_weapons/Wpn_smittyspecial_fire2d_01.wav")
...
SWEP.IronSightsPos     = Vector(0, -1, 0.5)
