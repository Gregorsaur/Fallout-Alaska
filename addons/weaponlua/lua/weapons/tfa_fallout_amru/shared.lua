SWEP.PrintName = "Anti Material Rifle (Unscoped)"
...
SWEP.IronSightsPos_EOTech = Vector(-3.056, -2, 0.612)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-3.056, -2, 0.612)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-3.056, -2, 0.612)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-3.056, 0, 0.612)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 50

SWEP.IronSightsPos_C79 = Vector(-3.056, 0, 0.194)
...
SWEP.Primary.Ammo_Rifle = "AlyxGun"
SWEP.Primary.Ammo_SG = "AlyxGun"
SWEP.Primary.Ammo_50cal = "AlyxGun"
...
SWEP.Primary.DefaultClip = 5 + 6 * 5
