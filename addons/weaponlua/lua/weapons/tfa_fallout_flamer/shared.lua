...
SWEP.PrintName				= "Heavy Flamer"		-- Weapon name (Shown on HUD)
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/heavy weapons/flamer.mdl"
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["flamer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/flamer.mdl", bone = "Base", rel = "", pos = Vector(19.444, 0.967, -20.73), angle = Angle(0, 90, 0), size = Vector(1.133, 1.133, 1.133), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["flamer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/flamer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.937, 14.274, 2.269), angle = Angle(-88.163, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.Attachments = {
