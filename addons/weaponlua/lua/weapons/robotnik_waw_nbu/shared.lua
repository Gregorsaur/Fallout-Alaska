...
SWEP.PrintName				= "Nambu (556 ammo)"		-- Weapon name (Shown on HUD)	
...
SWEP.SightsPos = Vector(-3.622, -3.641, 1.434)
SWEP.SightsAng = Vector(0.6, -0.101, 0)
SWEP.RunSightsPos = Vector (3.599, 0, 0.92)
SWEP.RunSightsAng = Vector (-10.7, 7, 12.6)
SWEP.InspectPos = Vector(6.432, 0, -1.28)
SWEP.InspectAng = Vector(8, 23.899, 5.8)
