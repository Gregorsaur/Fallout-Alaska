...
if (CLIENT) then
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/varmintriflesilext.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.337, -2.391, -4.574), angle = Angle(0.174, 0.112, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/varmintriflesilext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.838, 1.345, 2.098), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Rifles/varmintriflesilext.mdl"
...
SWEP.IronSightsPos = Vector(6, -1, 3.55)
SWEP.IronSightsAng = Vector(-0.07, 0.258, 0)
