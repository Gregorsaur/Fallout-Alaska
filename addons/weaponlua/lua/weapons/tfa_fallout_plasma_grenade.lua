...
SWEP.Primary.Round 	     = ("tfa_fallout_thrown_plasma_greande")
SWEP.Velocity            = 1000
SWEP.Velocity_Underhand  = 600

SWEP.ViewModel			 = "models/weapons/tfa_fallout/c_fallout_plasmagrenade.mdl"
...
SWEP.ViewModelBoneMods = {
	["R Finger11"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.1, 0), angle = Angle(-5, -5, 0) },
	["R Finger21"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.2, 0), angle = Angle(0, 0, 0) },
	["R Finger31"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(1.5, -2, 0) },
	["R Finger41"] = { scale = Vector(1, 1, 1), pos = Vector(0,-0.1, 0), angle = Angle(3, -2.4, 0) },
}
...
SWEP.WorldModel			 = "models/weapons/tfa_fallout/w_fallout_plasmagrenade.mdl"
