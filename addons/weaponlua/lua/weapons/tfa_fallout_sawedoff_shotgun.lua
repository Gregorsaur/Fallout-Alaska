...
SWEP.PrintName				= "Sawedoff Shotgun" -- Weapon name (Shown on HUD)
SWEP.Slot				    = 1			         -- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 73			     -- Position in the slot
SWEP.AutoSwitchTo			= true		         -- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= true		         -- Auto switch from if you pick up a better weapon
SWEP.Weight				    = 30			     -- This controls how "good" the weapon is for autopickup.
SWEP.Type                   = "Break Action Shotgun"
...
SWEP.Primary.Sound          = Sound("Sawedoff_Shotgun.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Damage            = 7.1          -- Damage, in standard damage points.
...
SWEP.Primary.RPM               = 234.4        -- This is in Rounds Per Minute / RPM
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_sawedoff_shotgun.mdl" -- Viewmodel path
...
SWEP.WorldModel	  = "models/weapons/tfa_fallout/w_fallout_sawedoff_shotgun.mdl" -- Weapon world model path
...
SWEP.IronSightsPos     = Vector(-1.925, -2.7, 1.2)
SWEP.IronSightsAng     = Vector(0.5, 0, 0)

--[[SPRINTING]]--

SWEP.RunSightsPos = Vector(3, -6, -6)  -- Change this, using SWEP Creation Kit preferably
...
SWEP.ViewModelBoneMods  = {
	["WeaponBASE"] = { scale = Vector(1, 1, 1), pos = Vector(0.3, 0, 0.2), angle = Angle(0, 0, 0) },
	["Shellstyo01"] = { scale = Vector(1, 1, 1), pos = Vector(0.3, 0, 0.2), angle = Angle(0, 0, 0) },
	["Shellstyo02"] = { scale = Vector(1, 1, 1), pos = Vector(0.3, 0, 0.2), angle = Angle(0, 0, 0) },
	["R UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-1.4, 0, 0), angle = Angle(0, 0, 0) },
	["R Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-10, 0, 0) },
	["A_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, -20, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "sg_frag", "sg_slug"}, order = 2 },
}
