SWEP.PrintName = "FM Chinese Assault Rifle"
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/fml/fallout/c_chingchong_ak.mdl"
...
SWEP.WElements = {
	["E"] = { type = "Model", model = "models/weapons/fml/fallout/c_chingchong_ak.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.678, 3.588, -6.074), angle = Angle(-10, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}

SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/fml/fallout/c_chingchong_ak.mdl", bone = "Weapon_Main", rel = "", pos = Vector(3.009, -6.31, -7.364), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1, [1] = 1, [2] = 1} },
}

SWEP.IronSightsPos = Vector(-3.04, -4, 1.07)
SWEP.IronSightsAng = Vector(0.669, 0, 0)
