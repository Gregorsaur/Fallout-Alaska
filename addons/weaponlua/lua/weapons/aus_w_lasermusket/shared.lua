...
SWEP.Category				= "Fallout | Weapons (Microfusion Cell)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Laser Musket"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("lasermusketshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_lasermusket.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_lasermusket.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4.56, 0, -0.12)
SWEP.IronSightsAng = Vector(1.317, -0.079, 0)
...
SWEP.MuzzleFlashEffect = "fo3_muzzle_gatlinglaser" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
--[[ATTACHMENTS]]--
 SWEP.WElements = {
 	["laser2+"] = { type = "Model", model = "models/effects/vol_light128x128.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(22.236, 0.991, -6.39), angle = Angle(84.67, -7.957, 6.663), size = Vector(0.009, 0.009, 0.107), color = Color(224, 0, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
 	["laser2"] = { type = "Model", model = "models/effects/vol_light64x256.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.553, 0.999, -6.656), angle = Angle(176.449, 6.992, 0), size = Vector(0.09, 0.028, 0.009), color = Color(218, 0, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
 ...
 SWEP.VElements = {
	["laser"] = { type = "Model", model = "models/effects/vol_light64x256.mdl", bone = "musket", rel = "", pos = Vector(1.932, -8.7, 0.972), angle = Angle(13.553, -75.193, 60.687), size = Vector(0.09, 0.028, 0.009), color = Color(218, 0, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["laser2"] = { type = "Model", model = "models/effects/vol_light128x128.mdl", bone = "musket", rel = "", pos = Vector(1.521, -20.071, -3.529), angle = Angle(106.919, 78.47, 6.663), size = Vector(0.009, 0.009, 0.107), color = Color(255, 0, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
