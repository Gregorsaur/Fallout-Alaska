...
SWEP.Category				= "Fallout | Weapons (9mm Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "9MM SMG"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Ammo = "9mmRound" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
