SWEP.PrintName = "10mm SMG (10mm ammo)"
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/fml/fallout/c_10mm_smg.mdl"
...
SWEP.WElements = {
	["E"] = { type = "Model", model = "models/weapons/fml/fallout/c_10mm_smg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.678, 3.588, -6.074), angle = Angle(-10, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}

SWEP.IronSightsPos = Vector(-2.399, -1.5, 0.639)
SWEP.IronSightsAng = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.398, -3, -0.871)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.398, -3, -0.871)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.398, -3, -0.871)
SWEP.IronSightsAng_RDS = Vector(-0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.398, 0, -0.871)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 50

SWEP.IronSightsPos_C79 = Vector(-2.395, 0, -1.285)
