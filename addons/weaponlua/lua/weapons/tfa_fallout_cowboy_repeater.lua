...
SWEP.PrintName				= "Cowboy Repeater (.38 Ammo)"  -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound                = Sound("TFA_Fallout.Cowboy_Repeater.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM               = 68           -- This is in Rounds Per Minute / RPM
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_cowboy_repeater.mdl" -- Viewmodel path
...
SWEP.WorldModel	  = "models/weapons/tfa_fallout/w_fallout_cowboy_repeater.mdl" -- Weapon world model path
...
SWEP.IronSightsPos     = Vector(-3.2, -1, 1.82)
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.25, 0.1), angle = Angle(0, 0, 0) },
...
--	["Ring1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -5, 0) },
	["Index1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-8, 0, 0) },
	["Middle1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-4, 0, 0) },
	["Pinky1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(5, 0, 0) },
