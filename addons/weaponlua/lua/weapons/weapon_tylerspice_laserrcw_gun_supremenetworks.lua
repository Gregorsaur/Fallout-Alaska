SWEP.Gun = ("weapon_tylerspice_laserrcw_gun_supremenetworks.lua") 
...
SWEP.VElements = {
	["lmg"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/laserpdwrecycler.mdl", bone = "v_weapon.m249", rel = "", pos = Vector(0.164, 5.202, -2.016), angle = Angle(-180, 0, -90), size = Vector(1.037, 1.037, 1.037), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["lmg"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/laserpdwrecycler.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.751, 1.08, 3.211), angle = Angle(0, 90.417, -169.42), size = Vector(1.037, 1.037, 1.037), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
