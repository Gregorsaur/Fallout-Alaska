...
SWEP.PrintName				= "Arisaka (.308 ammo)"		-- Weapon name (Shown on HUD)	
...
SWEP.SightsPos = Vector(-2.661, -1.64, 3)
SWEP.SightsAng = Vector(-0.601, -0.101, 0)
SWEP.RunSightsPos = Vector (6.32, -5.04, -7.921)
SWEP.RunSightsAng = Vector (28.899, 48.2, 11.199)
SWEP.InspectPos = Vector(7.4, 0, -1.121)
SWEP.InspectAng = Vector(12.399, 21, 17.6)
SWEP.Offset = {
        Pos = {
        Up = 2,
        Right = 0,
