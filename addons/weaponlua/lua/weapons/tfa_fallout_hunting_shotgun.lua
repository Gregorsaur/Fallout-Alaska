...
SWEP.PrintName				= "Hunting Shotgun"  -- Weapon name (Shown on HUD)
...
SWEP.ShellTime              = .62       -- For shotguns, how long it takes to insert a shell.

--[[ WEAPON HANDLING ]]--

SWEP.Primary.Sound          = Sound("TFA_FALLOUT.Hunting_Shotgun.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.FireModeName      = "PUMP-ACTION"  -- C hange to a text value to override it
...
--Recoil Related
SWEP.Primary.KickUp              = 2.58  -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown            = 1.43  -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal      = 0.61  -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor  = 0.54  -- Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.

--Firing Cone Related
SWEP.Primary.Spread              = .038  -- This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy        = .031  -- Ironsight accuracy, should be the same for shotguns

--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.

SWEP.Primary.SpreadMultiplierMax = 2.45  -- How far the spread can expand when you shoot. Example val: 2.5
SWEP.Primary.SpreadIncrement     = 2.2   -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery      = 3.38  -- How much the spread recovers, per second. Example val: 3
...
SWEP.CrouchAccuracyMultiplier = 0.72     -- Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_hunting_shotgun.mdl" -- Viewmodel path
SWEP.ViewModelFOV	= 50		       -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip	= false		       -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands       = true             -- Use gmod c_arms system.
SWEP.VMPos          = Vector(-1, -2, 1) -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.WorldModel	  = "models/weapons/tfa_fallout/w_fallout_hunting_shotgun.mdl" -- Weapon world model path
...
SWEP.IronSightsPos     = Vector(-3.9, -3, 2)
SWEP.IronSightsAng     = Vector(2.2, 0.02, 0)

--[[SPRINTING]]--

SWEP.RunSightsPos   = Vector(3, -5, -3)
SWEP.RunSightsAng   = Vector(-0, 35, -15)
--[[INSPECTION]]--

SWEP.InspectPos   = Vector(8.5, -5, -2.787)
SWEP.InspectAng   = Vector(15, 32.417, 5)

--[[ATTACHMENTS]]--

SWEP.ViewModelBoneMods = {
	["ValveBiped.weapon_bone"] = { scale = Vector(1, 1, 1), pos = Vector(-0.2, 0.6, 0), angle = Angle(0, 0, 0) },
