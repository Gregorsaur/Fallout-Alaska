...
SWEP.PrintName				= "The Maria"             -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound             = Sound("TFA_FALLOUT.9MM_Pistol.Fire")            -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound     = Sound("TFA_FALLOUT.9MM_Pistol.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1.25      -- Change the amount of something this gun can penetrate through
...
SWEP.Primary.Velocity          = 450           -- Bullet Velocity in m/s
...
SWEP.Primary.SpreadMultiplierMax = 3.72         -- How far the spread can expand when you shoot. Example val: 2.5
SWEP.Primary.SpreadIncrement     = 1.15         -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery      = 5.94         -- How much the spread recovers, per second. Example val: 3
...
SWEP.Primary.Range        = 0.032 * (3280.84 * 16) -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.IronSightsPos     = Vector(-2.1105, -2, 0.46)
SWEP.IronSightsAng     = Vector(0.1, 0, 0)

--[[ SPRINTING ]]--

SWEP.RunSightsPos   = Vector(1.25, -9, -10)
SWEP.RunSightsAng   = Vector(50, 0, 0)

--[[ INSPECTION ]] --

SWEP.InspectPos     = Vector(8, -7.658, -2.241) 
SWEP.InspectAng     = Vector(24.622, 42.915, 15.477)

--[[ VIEWMODEL ]]--

SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_maria_pistol.mdl" -- Viewmodel path

SWEP.VMPos          = Vector(-0.25, 1, 0)
...
SWEP.WorldModel	    = "models/weapons/tfa_fallout/w_fallout_maria_pistol.mdl" -- Weapon world model path
...
--	["R UpperArm"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["Weapon"] = { scale = Vector(1.15, 1.15, 1.15), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["Slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.27), angle = Angle(0, 0, 0) },
	["Hammer"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.65, 0.22), angle = Angle(0, 0, 0) },
	["Magazine"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.5, -0.15), angle = Angle(0, 0, 0) },
	["Trigger"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.25), angle = Angle(0, 0, 0) },
--	["L Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(3, -3, 0) },
	["A_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.65, 0.4), angle = Angle(0, 0, 0) },
