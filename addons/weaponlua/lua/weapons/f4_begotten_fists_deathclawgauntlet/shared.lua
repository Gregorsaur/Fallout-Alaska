...
SWEP.BlockSound1 = Sound("physics/wood/wood_plank_impact_soft"..math.random(1, 3)..".wav");
SWEP.BlockSound2 = Sound("physics/body/body_medium_impact_hard"..math.random(1, 6)..".wav");
...
//This if shot the bullets
	...
	if ( tr.Hit ) then
		...
		bullet.Damage = math.random( 30, 35 )
...
SWEP.VElements = {
	...
	["v_deathclawgauntlet"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/deathclawgauntlet.mdl", bone = "r-rist", rel = "", pos = Vector(-2.1, 0.518, -0.519), angle = Angle(8.182, -94.676, -90), size = Vector(0.79, 0.79, 0.79), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_deathclawgauntlet"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/deathclawgauntlet.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.676, 0.518, -0.519), angle = Angle(-180, 85.324, 92.337), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}