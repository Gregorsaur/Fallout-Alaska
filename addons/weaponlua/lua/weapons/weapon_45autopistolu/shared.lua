...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/45autopistolunique.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.054, 3.012, 8.053), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Pistols/45autopistolunique.mdl"
...
SWEP.IronSightsPos = Vector(4.5, -2, 3)
SWEP.IronSightsAng = Vector(0.1, -0.205, 0)
