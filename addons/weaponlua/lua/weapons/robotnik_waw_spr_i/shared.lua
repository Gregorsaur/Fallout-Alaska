...
SWEP.SightsPos = Vector(-2.07, -2.441, 1.74)
SWEP.SightsAng = Vector(0.699, -0.101, 0)
SWEP.RunSightsPos = Vector (4.4, 0, -2.84)
SWEP.RunSightsAng = Vector (5.3, 44.5, 0)
SWEP.InspectPos = Vector(10.451, 0, 0)
SWEP.InspectAng = Vector(-3, 34.7, 9.3)
