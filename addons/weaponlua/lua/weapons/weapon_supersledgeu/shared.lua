...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/supersledgeunique.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(3.536, -2.277, -11.804), angle = Angle(-7.768, -75.276, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/supersledgeunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.798, 1.957, 13.668), angle = Angle(180, -109.561, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.MissSound 				= Sound("weapons/props_dane/rebarclub/swing0.wav")
SWEP.WallSound 				= Sound("weapons/props_dane/rebarclub/impact0.wav")
