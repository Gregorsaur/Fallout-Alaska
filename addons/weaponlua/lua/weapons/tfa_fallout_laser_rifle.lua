...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Laser Rifle"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/laserrifle/c_laserrifle.mdl"	-- Weapon view model
SWEP.WorldModel 			= "models/weapons/laserrifle/w_laserrifle.mdl"	-- Weapon world model
