...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/fml/fallout/c_bozar.mdl"
...
SWEP.ViewModelBoneMods = {
	...
	["A_Optic"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.412, -2.474), angle = Angle(0, 180, 0) },
}

SWEP.WElements = {
	["E"] = { type = "Model", model = "models/weapons/fml/fallout/c_bozar.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.678, 3.588, -6.074), angle = Angle(-10, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}

SWEP.IronSightsPos = Vector(-3.8, -4.038, 1.049)
SWEP.IronSightsAng = Vector(1.702, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-3.724, -3, 0.704)
SWEP.IronSightsAng_EOTech = Vector(-0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-3.724, -3, 0.704)
SWEP.IronSightsAng_Kobra = Vector(-0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-3.724, -3, 0.704)
SWEP.IronSightsAng_RDS = Vector(-0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-3.724, -1, 0.704)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 50

SWEP.IronSightsPos_C79 = Vector(-3.725, -1, 0.3)
...
SWEP.Primary.Sound = Sound("weapons/riflecar/wpn_car.wav") -- This is the sound of the weapon, when you shoot.
