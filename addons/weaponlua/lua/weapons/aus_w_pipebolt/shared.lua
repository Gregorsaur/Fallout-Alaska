...
SWEP.PrintName				= "Pipe Bolt-Action"		-- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_pipebolt.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_pipebolt.mdl" -- Weapon world model path
...
--Vector(6.854, 0.596, -1.45), angle = Angle(-10.268, 0, 175.947) pipe
...
SWEP.IronSightsPos = Vector(-6.481, -3.12, 2.64)
