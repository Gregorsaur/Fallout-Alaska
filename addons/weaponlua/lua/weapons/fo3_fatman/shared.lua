...
SWEP.Gun = ("m9k_fatman") -- must be the name of your swep but NO CAPITALS!
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "bobs_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Category				= "Fallout Sweps"
SWEP.Author				= "Zayn"
SWEP.Contact				= "Time To Fuck Shit Up"
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment			= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Fat Man"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_fatman.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_fatman.mdl"	-- Weapon world model
