...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Laser Rifle Beam Splitter"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/laserrifle/c_laserrifle_beamsplitter.mdl"	-- Weapon view model
SWEP.WorldModel 			= "models/weapons/laserrifle/w_laserrifle_beamsplitter.mdl"	-- Weapon world model
...
-- Enter iron sight info and bone mod info below
SWEP.IronSightsPos = Vector(-2.6, 0, 0.65)
