...
SWEP.Contact			 = ""
SWEP.PrintName			 = "Radiation Grenade"
SWEP.Purpose			 = ""
SWEP.Type				 = "Grenade"
SWEP.Slot				 = 4
SWEP.SlotPos			 = 99
...
SWEP.Primary.Ammo		 = "RadiationGrenade"
SWEP.Primary.Round 	     = ("tfa_fallout_thrown_radiation_greande")
SWEP.Velocity            = 1000
SWEP.Velocity_Underhand  = 600

SWEP.ViewModel			 = "models/weapons/tfa_fallout/c_fallout_cryogrenade.mdl"
...
SWEP.ViewModelBoneMods = {
	["R Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-10, -1.5, 0) },
	["R Finger11"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.1, 0), angle = Angle(-5, -7, 0) },
	["R Finger21"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.2, 0), angle = Angle(0, 0, 0) },
	["R Finger41"] = { scale = Vector(1, 1, 1), pos = Vector(0,-0.1, 0), angle = Angle(0, 1, 0) },
}
...
SWEP.WorldModel			 = "models/weapons/tfa_fallout/w_fallout_cryogrenade.mdl"
