...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/supersledge.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(3.536, -1.277, -11.804), angle = Angle(0, -77.276, -1), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
