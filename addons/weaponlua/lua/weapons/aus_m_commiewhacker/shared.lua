...
SWEP.VElements = {
	["v_commiewhacker"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/commiewhacker.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.799, 0.518), angle = Angle(1.169, -3.507, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["w_commiewhacker"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/commiewhacker.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 0.518), angle = Angle(5.843, -73.637, 174.156), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}