...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/warclub.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(2.051, -1.03, -2.415), angle = Angle(-0.917, -92.514, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/warclub.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.48, 0.293, 4.071), angle = Angle(180, 180, 1.2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
