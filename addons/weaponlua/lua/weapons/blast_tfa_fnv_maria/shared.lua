...
SWEP.Gun = ("blast_tfa_fnv_maria") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Purpose				= ""
SWEP.Instructions			= ""
SWEP.PrintName				= "Maria"		-- Weapon name (Shown on HUD)	
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_fnv_maria.single") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip = 117 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Range Related
SWEP.Primary.Range = 50 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel				= "models/weapons/c_fnv_maria_tfa.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_fnv_maria_tfa.mdl" -- Weapon world model path
...
--[[HOLDTYPES]]--
SWEP.ReloadHoldTypeOverride = "pistol" --This variable overrides the ironsights holdtype, choosing it instead of something from the above tables.  Change it to "" to disable.
...
SWEP.IronSightsPos = Vector(-3.744, 0, 1.179)
SWEP.IronSightsAng = Vector(-0.021, 0.215, 0)
...
--[[INSPECTION]]--
SWEP.InspectPos = Vector(11, 0.183, 2.88)
