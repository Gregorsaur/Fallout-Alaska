...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("fo410mm_nope.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 510 -- This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/falloutweapons/c_fo410mm_nope.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/falloutweapons/w_fo410mm_nope.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4.009, 0.025, 0.37)
SWEP.IronSightsAng = Vector(-0.217, -5.125, 0.146)
--[[INSPECTION]]--
...
SWEP.SprintAnimation = {
	["in"] = {
		...
		["value"] = "idle2sprint", --Number for act, String/Number for sequence
		["transition"] = true
	}, --Inward transition
	["loop"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, --Sequence or act
	...
	["out"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, --Sequence or act
		["value"] = "sprint2idle", --Number for act, String/Number for sequence
		["transition"] = true
	} --Outward transition
}
--[[EFFECTS]]--
