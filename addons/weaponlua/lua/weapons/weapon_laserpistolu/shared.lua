...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserpistolunique.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.202, -3.04, -0.083), angle = Angle(1.023, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserpistolunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.858, 2.269, 1.748), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.Primary.Sound 		= Sound("weapons/pistollaser/wpn_pistollaser_fire.wav")
...
SWEP.IronSightsPos = Vector(3.913, -1.5, 1.427)
SWEP.IronSightsAng = Vector(0.824, -0.009, -1.175)
