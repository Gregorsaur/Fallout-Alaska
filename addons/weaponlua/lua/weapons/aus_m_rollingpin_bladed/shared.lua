...
SWEP.PrintName = "Bladed Rolling Pin"
...
SWEP.VElements = {
	["v_rollingpin_bladed"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/rollingpin.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, -0.519), angle = Angle(1.169, -94.676, -176.495), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 3} },
...
SWEP.WElements = {
	["w_rollingpin_bladed"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/rollingpin.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.4, 1.299, -0.519), angle = Angle(3.506, -104.027, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 3} }
}