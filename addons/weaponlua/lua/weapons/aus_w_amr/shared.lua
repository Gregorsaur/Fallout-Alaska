...
SWEP.Category				= "Fallout | Weapons (.50MG Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Anti-Material Rifle"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("amrshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Ammo = "AlyxGun" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_amr.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_amr.mdl" -- Weapon world model path
...
--Vector(7.557, 0.966, -1.558), angle = Angle(-8.259, 2.858, -180) amr
...
SWEP.IronSightsPos = Vector(-4.56, -7.68, 0.119)
SWEP.IronSightsAng = Vector(0.158, -3.518, 0.0)
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "amr", rel = "", pos = Vector(3.598, 2.434, -0.44), angle = Angle(-3.352, -99.442, -90), size = Vector(0.367, 0.367, 0.367), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
--[[AKIMBO]]--
