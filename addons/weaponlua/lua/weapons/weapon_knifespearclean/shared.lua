...
SWEP.PrintName				= "Dirty Knife Spear"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel				= "models/Halokiller38/fallout/weapons/Melee/knifespearclean.mdl"	-- Weapon world model
...
SWEP.Primary.Ammo			= "Clean_Knife_Spear"				
-- pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, AirboatGun
-- Pistol, buckshot, and slam always ricochet. Use AirboatGun for a metal peircing shotgun slug

SWEP.Primary.Round 			= ("ent_halo_knifespearclean")	--NAME OF ENTITY GOES HERE
...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/knifespearclean.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.348, 1.661, -15.995), angle = Angle(180, -180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

if file.Exists( "models/weapons/v_knife_t.mdl", "GAME" ) then
	SWEP.ViewModel				= "models/weapons/v_knife_t.mdl"	-- Weapon view model
		SWEP.VElements = {
			["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/knifespearclean.mdl", bone = "v_weapon.knife_Parent", rel = "", pos = Vector(-2.072, -8.018, 4.151), angle = Angle(39.28, -16.566, 2.506), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}
	...
	SWEP.ViewModel				= "models/weapons/v_invisib.mdl"	-- Weapon view model
		SWEP.VElements = {
			["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/knifespearclean.mdl", bone = "Da Machete", rel = "", pos = Vector(-16.342, -0.5, 26.829), angle = Angle(28.08, -34.35, -3.268), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}
		SWEP.ViewModelBoneMods = {
