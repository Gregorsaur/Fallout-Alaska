...
SWEP.PrintName = "Metal Chained Bat"
...
SWEP.VElements = {
	["v_baseballbat_chained"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/baseballbat.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 8.831), angle = Angle(0, -92.338, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 10, bodygroup = {[0] = 3} },
...
SWEP.WElements = {
	["w_baseballbat_chained"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/baseballbat.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, -0.519, 9.869), angle = Angle(10.519, -40.91, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 10, bodygroup = {[0] = 3} }
}
