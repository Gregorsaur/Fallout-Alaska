...
SWEP.PrintName				= "PTRS-41 (556 ammo) "		-- Weapon name (Shown on HUD)	
...
SWEP.HoldType 				= "GaussEnergy"		-- how others view you carrying the weapon
...
SWEP.Primary.Ammo			= "50MG"			-- pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, AirboatGun
...
SWEP.SightsPos = Vector(-4.653, -5.12, 1.853)
SWEP.SightsAng = Vector(0, 0, 0)
SWEP.RunSightsPos = Vector (1.48, -9.28, -9.881)
SWEP.RunSightsAng = Vector (7.3, 56.299, -22.976)
SWEP.InspectPos = Vector(4.92, -3.481, 0.56)
SWEP.InspectAng = Vector(6, 20.299, 8.1)
