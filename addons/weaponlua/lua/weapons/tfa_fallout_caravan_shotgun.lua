...
SWEP.PrintName				= "Caravan Shotgun"  -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound             = Sound("TFA_FALLOUT.Caravan_Shotgun.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM               = 144.6        -- This is in Rounds Per Minute / RPM
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_caravan_shotgun.mdl" -- Viewmodel path
SWEP.ViewModelFOV	= 70		       -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip	= false		       -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands       = true             -- Use gmod c_arms system.
SWEP.VMPos          = Vector(-0.2, 3, 0)  -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
SWEP.VMAng          = Vector(1, 0.1, 0)  -- The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
...
SWEP.WorldModel	  = "models/weapons/tfa_fallout/w_fallout_caravan_shotgun.mdl" -- Weapon world model path
...
SWEP.IronSightsPos     = Vector(-2.72, 0, 1)
SWEP.IronSightsAng     = Vector(1, 0.05, 0)
...
SWEP.InspectPos   = Vector(4.2, -2, -2.787)
...
--	["tag_Weapon"] = { scale = Vector(0.98, 0.98, 0.98), pos = Vector(-0.1, 0, 0), angle = Angle(0, 0, 0) },
	["j_shell_top"] = { scale = Vector(1.3, 1.01, 1.01), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["j_shell_bottom"] = { scale = Vector(1.3, 1.01, 1.01), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
