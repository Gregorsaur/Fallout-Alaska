...
SWEP.Category				= "Fallout | Weapons (Shotgun Shells)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Combat Shotgun"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM = 230 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi = 230 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
