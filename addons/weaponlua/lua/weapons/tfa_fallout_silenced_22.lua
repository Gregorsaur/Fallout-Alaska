...
SWEP.PrintName				= "Silenced .22"          -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound             = Sound("TFA_FALLOUT.Silenced_22.Fire")            -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Velocity          = 180           -- Bullet Velocity in m/s
...
SWEP.Primary.SpreadRecovery      = 6.3          -- How much the spread recovers, per second. Example val: 3
...
SWEP.Primary.Range        = 0.0140 * (3280.84 * 16) -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.IronSightsPos     = Vector(-2.128, 0, 0.49)
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_silenced_22.mdl" -- Viewmodel path
...
SWEP.WorldModel	    = "models/weapons/tfa_fallout/w_fallout_silenced_22.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	...
	["Slide"] = { scale = Vector(1.15, 1.15, 1.15), pos = Vector(0, -0.65, 0.28), angle = Angle(0, 0, 0) },
	["Magazine"] = { scale = Vector(1.15, 1.15, 1.15), pos = Vector(0, -0.1, -0), angle = Angle(0, 0, 0) },
	["Trigger"] = { scale = Vector(1.15, 1.15, 1.15), pos = Vector(0, 0, 0.15), angle = Angle(0, 0, 0) },
	["A_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.35, 0.35), angle = Angle(0, 0, 0) },
	["A_Eject"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.72, 0), angle = Angle(0, 0, 0) },
	["R Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.2, 0), angle = Angle(-5, 0, 5) },
