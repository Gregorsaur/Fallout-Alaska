...
//This if shot the bullets
	...
	if ( tr.Hit ) then
		...
		bullet.Damage = math.random( 100, 130 )
...
SWEP.VElements = {
	["v_sledgehammer_maul"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/sledgehammer.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-3.3, 8.831, -0.519), angle = Angle(-73.637, 38.57, -50.26), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,  bodygroup = {[0] = 6} },
...
SWEP.WElements = {
	["w_sledgehammer_maul"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/sledgehammer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.557, 2.596), angle = Angle(180, 64.286, 1.169), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,  bodygroup = {[0] = 6} }
}
