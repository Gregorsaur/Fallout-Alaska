...
SWEP.PrintName				= "Mosin-Nagant Scoped (.308 ammo)"		-- Weapon name (Shown on HUD)	
...
SWEP.SightsPos = Vector(-2.224, -1.081, 0.72)
SWEP.SightsAng = Vector(0, 0, 0)
SWEP.RunSightsPos = Vector (0.67, 0, -1.127)
SWEP.RunSightsAng = Vector (-14.7, 42.7, -26.976)
SWEP.InspectPos = Vector(5.519, 0, 1.6)
SWEP.InspectAng = Vector(-9.4, 26.1, 9.199)
