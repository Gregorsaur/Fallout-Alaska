...
SWEP.Primary.Sound             = Sound("TFA_FALLOUT.Marksman_Carbine.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.IronSightsPos     = Vector(-3, -1.5, 0.2)
SWEP.IronSightsAng     = Vector(1.08, 0.24, 0)
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_marksman_carbine.mdl" -- Viewmodel path
...
SWEP.WorldModel	    = "models/weapons/tfa_fallout/w_fallout_marksman_carbine.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	["L Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0.1, 3, 0) },
	["L Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 2, 0) },
	["L Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6.5, 0, 0) },
	["L Finger3"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6.5, 0, 0) },
	["L Finger4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6.5, 0, 0) },
	["R Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.3, 0), angle = Angle(-10, 0, 0) },
	["A_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 1, 0), angle = Angle(0, 0, 0) },
--	["R UpperArm"] = { scale = Vector(0.95, 0.95, 0.95), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
--	["R Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.15, 0), angle = Angle(0, 0, 0) },
...
--	["A_Eject"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.5, 0), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Weapon", rel = "", pos = Vector(-0.26, -8, 5.95), angle = Angle(0, 90, 0), size = Vector(0.25, 0.25, 0.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false }
}
