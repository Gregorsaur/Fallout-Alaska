...
SWEP.Category				= "Fallout | Weapons (12.7mm Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "12.7MM Pistol"		-- Weapon name (Shown on HUD)
