...
SWEP.Manufacturer = "Bazalt" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_RPG7.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Ammo = "ins2_rpg" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
SWEP.Primary.Projectile = "tfa_ins2_rpg_proj" --Entity to shoot
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_rpg.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_rpg.mdl" -- Weapon world model path
...
SWEP.Attachments = {
	[2] = { offset = { 0, 0 }, atts = { "rpg_dud" }, order = 1 },
}
...
function SWEP:ShootBullet()
	if SERVER then
		timer.Simple( self:GetStat("Primary.ProjectileDelay"),function()
