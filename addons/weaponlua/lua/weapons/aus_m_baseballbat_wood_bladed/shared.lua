...
SWEP.VElements = {
	["v_baseballbat_bladed"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/baseballbat.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 8.831), angle = Angle(0, -92.338, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 3, bodygroup = {[0] = 9, [1] = 2} },
...
SWEP.WElements = {
	["w_baseballbat_bladed"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/baseballbat.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, -0.519, 7.791), angle = Angle(10.519, -80.65, -171.818), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 3, bodygroup = {[0] = 9, [1] = 2} }
}