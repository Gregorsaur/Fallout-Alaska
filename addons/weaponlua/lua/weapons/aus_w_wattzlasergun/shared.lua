...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("wattzshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_wattzlasergun.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_wattzlasergun.mdl" -- Weapon world model path
...
--Vector(7.662, 0.728, -1.828), angle = Angle(-12.546, 1.641, 180) wattz
...
SWEP.IronSightsPos = Vector(-4.022, -4, -0.196)	
SWEP.IronSightsAng = Vector(0, 0, 0)
local scope = {}

SWEP.RTMaterialOverride = -6 --the number of the texture, which you subtract from GetAttachment
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "wattzgun", rel = "", pos = Vector(3.226, 1.353, -0.267), angle = Angle(-0.729, -99.931, -90), size = Vector(0.404, 0.652, 0.456), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
