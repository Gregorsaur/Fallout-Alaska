...
SWEP.Category				= "Fallout | Weapons (.45 Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Submachine Gun"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tommygunshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Ammo = "SMG1_Grenade" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_tommygun.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_tommygun.mdl" -- Weapon world model path
...
-- Vector(8.102, 0.326, -1.517), angle = Angle(-8.174, 1.978, 180) tommy
...
SWEP.IronSightsPos = Vector(-4.151, 0, 2.319)
SWEP.IronSightsAng = Vector(0.07, -2.151, 0)
