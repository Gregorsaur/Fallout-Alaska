...
SWEP.ParrySound = Sound("weapons/katanasounds/katana_swing_miss2.wav")
...
local SwingSound = Sound( "weapons/katanasounds/katana_swing_miss1.wav" )
local HitSoundWorld = Sound( "weapons/katanasounds/katana_impact_world1.wav" )
local HitSoundBody = Sound( "weapons/dagger/skyrim_dagger_flesh1.mp3" )
...
SWEP.VElements = {
	["v_machete_kremvhstooth"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/machete.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 1.6, 4.599), angle = Angle(1.169, -92.338, -169.482), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 2} },
...
SWEP.WElements = {
	["w_machete_kremvhstooth"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/machete.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.4, 0.518, 7), angle = Angle(3.506, -104.027, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 2} }
}