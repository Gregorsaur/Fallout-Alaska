...
SWEP.Gun = ("xoma_x4_ots02") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Category				= "Fallout" --Category where you will find your weapons
SWEP.Author				= "Xoma-X4"
...
SWEP.PrintName				= "OTs-02 Kiparis"		-- Weapon name (Shown on HUD)	
...
SWEP.WElements = {
	--["gun"] = { type = "Model", model = "models/weapons/krycek/w_kry_mp5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.201, 0, 0.5), angle = Angle(-4, -1, 180), size = Vector(0.92, 0.92, 0.92), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}