...
SWEP.IronSightsPos_EOTech = Vector(-2.745, -3, -0.5)
SWEP.IronSightsAng_EOTech = Vector(-0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.745, -3, -0.5)
SWEP.IronSightsAng_Kobra = Vector(-0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.745, -3, -0.5)
SWEP.IronSightsAng_RDS = Vector(-0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.745, -3, -0.5)
...
SWEP.Primary.Ammo = "aus_10mm_ammo"
SWEP.Primary.DefaultClip = 17 + 16 * 5
