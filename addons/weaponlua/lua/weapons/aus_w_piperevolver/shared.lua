...
SWEP.PrintName				= "Pipe Revolver"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("piperevoshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_piperevolver.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_piperevolver.mdl" -- Weapon world model path
...
--Vector(7.17, 0.446, -1.823), angle = Angle(-9.676, -1.433, -180) rev
...
SWEP.IronSightsPos = Vector(-5.04, 0, 0.439)
SWEP.IronSightsAng = Vector(0.2, -2.401, 0)
