SWEP.PrintName = "Chinese Assault Rifle (556 ammo)"
...
SWEP.IronSightsPos_EOTech = Vector(-3.013, -6, 0.035)
SWEP.IronSightsAng_EOTech = Vector(-0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-3.013, -6, 0.035)
SWEP.IronSightsAng_Kobra = Vector(-0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-3.013, -6, 0.035)
SWEP.IronSightsAng_RDS = Vector(-0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-3.013, -2, 0.035)
...
SWEP.Primary.DefaultClip = 31 + 30 * 3
