...
SWEP.PrintName = "Revolutionary Sword"
...
//This if shot the bullets
	...
	if ( tr.Hit ) then
		...
		bullet.Damage = math.random( 10, 30 )
...
SWEP.VElements = {
	["v_revolutionarysword"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/revolutionarysword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.6, 1), angle = Angle(-10.52, -118.053, -171.818), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["w_revolutionarysword"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/revolutionarysword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 1.5, 1), angle = Angle(-31.559, -139.092, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}