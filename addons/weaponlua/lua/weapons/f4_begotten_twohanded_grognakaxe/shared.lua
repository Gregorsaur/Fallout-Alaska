...
local SwingSound = Sound( "weapons/axe/skyrim_axe_swing1.mp3" )
...
//This if shot the bullets
	...
	if ( tr.Hit ) then
		...
		bullet.Damage = math.random( 75, 100 )
...
SWEP.VElements = {
	["v_grognakaxe"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/grognakaxe.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-3.5, 4.675, 0.518), angle = Angle(100, 36.234, -125.066), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["w_grognakaxe"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/grognakaxe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.557, 2.596), angle = Angle(180, 64.286, 1.169), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
