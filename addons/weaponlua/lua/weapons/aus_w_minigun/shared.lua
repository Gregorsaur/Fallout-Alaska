...
SWEP.Gun = ("aus_w_minigun") -- Must be name of the folder this .lua file is in!
...
SWEP.UseHands				= true
SWEP.Category				= "Fallout | Weapons (5mm Rounds)" --Category where you will find your weapons
