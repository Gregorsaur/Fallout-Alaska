...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/firehydrant.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(4.537, -0.856, -18.841), angle = Angle(0.3, -74.137, 0), size = Vector(0.531, 0.531, 0.531), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/firehydrant.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.121, 2.045, 33.111), angle = Angle(180, -89.548, 0), size = Vector(0.501, 0.501, 0.501), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
