SWEP.Gun					= ("tfa_fallout_assault_carbine") --Make sure this is unique.  Specically, your folder name.
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "tfa_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "TFA Fallout Weapons" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer = "" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "dangerman1973" --Author Tooltip
...
SWEP.PrintName				= "Assault Carbine"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Weapon_cm733_carbine.single")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/v_m733.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/w_m733.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(2.612, 0, 1.004) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-6.332, 22.513, 0) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-6.085, -13, 2.049) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(-0.25, -0.04, 0) --Change this, using SWEP Creation Kit preferably
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 5.556, 0) },
	["ValveBiped.Bip01_R_Finger32"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -5.557, 0) },
	["ValveBiped.Bip01_R_Finger22"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 3.332, 0) },
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-0.051, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_R_Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(10, -10, 0) },
	["ValveBiped.Bip01_R_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(12.222, 0, 0) },
	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 14.444, 0) },
	["fire_select"] = { scale = Vector(1, 1, 1), pos = Vector(0.2, 0.109, -0), angle = Angle(0, 0, 0) }
}
