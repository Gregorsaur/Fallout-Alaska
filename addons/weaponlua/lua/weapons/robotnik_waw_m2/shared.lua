...
SWEP.Category				= "Mac's CoD WaW SWEPs" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "M2 Flamethrower"		-- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/v_waw_flamethrower.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_waw_flamethrower.mdl" -- Weapon world model path
