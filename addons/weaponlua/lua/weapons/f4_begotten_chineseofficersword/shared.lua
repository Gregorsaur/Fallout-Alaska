...
local SwingSound = Sound( "weapons/dagger/skyrim_dagger_swing1.mp3" )
...
SWEP.VElements = {
	["v_chienseofficersword"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/chineeseofficersword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 1.6, 4.599), angle = Angle(1.169, 78.311, 167.143), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["w_chineseofficersword"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/chineeseofficersword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.557, 4.675), angle = Angle(1.169, 80.649, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}