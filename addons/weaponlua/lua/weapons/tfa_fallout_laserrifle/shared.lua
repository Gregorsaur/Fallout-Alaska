...
SWEP.Gun = ("tfa_fallout_laserrifle") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Laser Rifle (Microfusion cells)"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/hub/weapons/laserrifle/c_laserrifle.mdl"	-- Weapon view model
SWEP.WorldModel 			= "models/hub/weapons/falloutweapons/w_plasmarifle.mdl"	-- Weapon world model
...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/hub/weapons/laserrifle/laserrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, 3.635), angle = Angle(-180, -90, 10.519), size = Vector(1.145, 1.145, 1.145), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
