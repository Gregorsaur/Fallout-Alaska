...
SWEP.PrintName				= "12MM Pistol"           -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound             = Sound("TFA_Fallout.12MM_Pistol.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound     = Sound("TFA_Fallout.12MM_Pistol.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.Velocity          = 400           -- Bullet Velocity in m/s
...
SWEP.Primary.KickUp             = 0.68                      -- This is the maximum upwards recoil (rise)
...
SWEP.Primary.SpreadMultiplierMax = 4.16         -- How far the spread can expand when you shoot. Example val: 2.5
SWEP.Primary.SpreadIncrement     = 1.33         -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery      = 5.85         -- How much the spread recovers, per second. Example val: 3

--[[ Movespeed ]]--

SWEP.MoveSpeed           = 1                      -- Multiply the player's movespeed by this.
SWEP.IronSightsMoveSpeed = 0.88                   -- Multiply the player's movespeed by this when sighting.
...
SWEP.IronSightsPos     = Vector(-2.55, 0, 1.5)
SWEP.IronSightsAng     = Vector(-0.1, -0.02, 0)

--[[ SPRINTING ]]--

SWEP.RunSightsPos   = Vector(3, -9, -7)
SWEP.RunSightsAng   = Vector(50, 0, 0)

--[[ INSPECTION ]] --

SWEP.InspectPos     = Vector(9.78, -9, -2.241) 
SWEP.InspectAng     = Vector(24.622, 42.915, 15.477)

--[[ VIEWMODEL ]]--

SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_12mm_pistol.mdl" -- Viewmodel path
...
SWEP.WorldModel	    = "models/weapons/tfa_fallout/w_fallout_12mm_pistol.mdl" -- Weapon world model path
