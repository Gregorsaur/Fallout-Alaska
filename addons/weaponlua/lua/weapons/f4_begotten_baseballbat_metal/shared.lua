...
SWEP.PrintName = "Металлический бейсбольный биток"
SWEP.Category = "Fallout 4"
SWEP.Author = "GostPlay"
SWEP.Instructions = "ЛКМ - удар | ПКМ - защита | R - парирование"
SWEP.Purpose = ""
...
SWEP.AmmoQuadColor = Color(0, 255, 0,255)
...
function SWEP:PrimaryAttack()
	...
	if self:Ammo1() < 10 then return end
