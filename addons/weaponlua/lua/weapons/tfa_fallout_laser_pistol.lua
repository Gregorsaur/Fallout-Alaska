...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Laser Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.VMPos          = Vector(-1.3, -1, -1)
SWEP.VMAng          = Vector(2, 4, 0)
SWEP.ViewModelFlip			= false
SWEP.ViewModel				= "models/weapons/laserpistol/c_laserpistol.mdl"	-- Weapon view model
SWEP.WorldModel 			= "models/weapons/laserpistol/w_laserpistol.mdl"	-- Weapon world model
...
SWEP.IronSightsPos = Vector(-2.6, 0, 0.1)
SWEP.IronSightsAng = Vector(1, 0, 0)

--[[ SPRINTING ]]--

SWEP.RunSightsPos   = Vector(3.5, -11.5, -8)
SWEP.RunSightsAng   = Vector(50, 0, 0)

SWEP.InspectPos = Vector(7.76, -5.178, 0.65)
SWEP.InspectAng = Vector(8, 37.277, 3.2)
