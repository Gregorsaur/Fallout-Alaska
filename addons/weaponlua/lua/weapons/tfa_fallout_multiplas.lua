...
SWEP.ViewModel				= "models/Fallout/fonv/plasmarifle/c_fallout_multiplas_rifle.mdl"	-- Weapon view model
SWEP.WorldModel 			= "models/Fallout/fonv/plasmarifle/w_fallout_multiplas_rifle.mdl"	-- Weapon world model
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(0.5, -0.4, 0), angle = Angle(0, 0, 0) },
}	

SWEP.Primary.Sound		    = Sound("weapons/fallout_new_vegas/plasma_weapons/Wpn_multiplasrifle_fire_2d_02.wav")
...
SWEP.Primary.KickUp		    = 0.012		-- Maximum up recoil (rise)
SWEP.Primary.KickDown	    = 0.012		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal = 0.012		-- Maximum up recoil (stock)
...
SWEP.IronSightsPos     = Vector(-4.035, -1, 0.5)
SWEP.IronSightsAng     = Vector(-2, -2.6, 0)
