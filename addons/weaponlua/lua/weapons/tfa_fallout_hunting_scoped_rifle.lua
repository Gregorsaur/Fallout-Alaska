...
SWEP.PrintName				= "Scoped Hunting Rifle"	   -- Weapon name (Shown on HUD)
...
SWEP.ViewModel			 = "models/weapons/tfa_fallout/c_fallout_hunting_scoped_rifle.mdl" 
...
SWEP.WorldModel	   = "models/weapons/tfa_fallout/w_fallout_hunting_scoped_rifle.mdl" -- Weapon world model path
...
SWEP.IronSightsPos          = Vector(-2.001, -1, 0.865)
...
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Weapon", rel = "", pos = Vector(0.85, -11.35, 4.52), angle = Angle(0, 90, 0), size = Vector(0.31, 0.31, 0.31), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false }
}
