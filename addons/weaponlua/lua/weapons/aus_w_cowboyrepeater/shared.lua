...
SWEP.Category				= "Fallout | Weapons (.44 Magnum Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Cowboy Repeater"		-- Weapon name (Shown on HUD)
