...
SWEP.PrintName				= "Pipe Bolt-Action (Scoped)"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("pipeboltshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_pipeboltscoped.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_pipeboltscoped.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-6.12, -4.628, 1.48)
SWEP.IronSightsAng = Vector(3.099, -1.101, 0)
