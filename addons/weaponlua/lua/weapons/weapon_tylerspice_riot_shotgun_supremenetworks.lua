SWEP.Gun = ("weapon_tylerspice_riot_shotgun_supremenetworks") 
...
SWEP.VElements = {
	["shotgun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/shotguns/combatshotgun.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0.331, 6.636, -35.731), angle = Angle(-180, 0, -90), size = Vector(1.5, 1.5, 1.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shotgun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/shotguns/combatshotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.617, 1.886, 2.989), angle = Angle(0, 92.188, -170.872), size = Vector(1.115, 1.115, 1.115), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
