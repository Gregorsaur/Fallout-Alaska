...
SWEP.PrintName				= "SG-510"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_bfh_sg510.mdl"	-- Weapon view model
...
SWEP.Primary.Sound			= Sound("bfh_sg510.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-2.965, -1.297, 0.736)
SWEP.SightsAng = Vector(-0.101, 0, 0)
SWEP.RunSightsPos = Vector (0.36, 0, -1.8)
SWEP.RunSightsAng = Vector (-13.301, 37.4, -18.201)
SWEP.InspectPos = Vector(3.92, 0, 2.2)
SWEP.InspectAng = Vector(-5.801, 10.399, 16.1)
