...
SWEP.VElements = {
	["v_board_spiked"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/board.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 10.909), angle = Angle(1.169, -94.676, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1} },
...
SWEP.WElements = {
	["w_board_spiked"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/board.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, -0.519, 10.909), angle = Angle(8.182, -78.312, -171.818), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1} }
}