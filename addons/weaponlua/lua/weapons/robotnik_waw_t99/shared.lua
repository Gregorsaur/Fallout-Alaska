...
SWEP.PrintName				= "Type-99 (556 ammo)"		-- Weapon name (Shown on HUD)	
...
SWEP.SightsPos = Vector(-3.721, -3.872, 5)
SWEP.SightsAng = Vector(-0.301, 0.5, 5.922)
SWEP.RunSightsPos = Vector (5.96, -7.361, -6.761)
SWEP.RunSightsAng = Vector (7.599, 51.5, 0)
SWEP.InspectPos = Vector(4.84, 0, 2.64)
SWEP.InspectAng = Vector(2.2, 17.799, 9)
