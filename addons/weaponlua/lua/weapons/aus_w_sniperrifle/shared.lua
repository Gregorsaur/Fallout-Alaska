...
SWEP.Category				= "Fallout | Weapons (.308 Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "DKS-501 Sniper Rifle"		-- Weapon name (Shown on HUD)
