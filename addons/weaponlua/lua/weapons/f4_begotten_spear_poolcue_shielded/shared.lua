...
SWEP.WElements = {
	...
	["skull"] = { type = "Model", model = "models/Gibs/HGIBS.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(2.596, 0.518, 5.714), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["sign1"] = { type = "Model", model = "models/props_c17/streetsign004e.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(0.699, 9.869, -12.988), angle = Angle(-87.663, -160.131, -68.961), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["baby"] = { type = "Model", model = "models/props_c17/doll01.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(0.518, 0.518, 0.518), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/flesh", skin = 0, bodygroup = {} },
	["sign2"] = { type = "Model", model = "models/props_c17/streetsign005d.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(0, 9.869, 18.181), angle = Angle(-54.936, -82.987, 8.182), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["sign3"] = { type = "Model", model = "models/props_c17/streetsign004f.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(0.518, -10.91, 11.947), angle = Angle(-66.624, -75.974, 12.857), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
