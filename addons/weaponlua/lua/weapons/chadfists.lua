...
if SERVER then
	...
	hook.Add("KeyRelease", "ChadFistsGrab", function(ply, key)
		if key == IN_ATTACK2 then
			local wep = ply:GetActiveWeapon()
			if IsValid(wep) and wep.IsChadFists and wep.ReadyToPickup then
				wep:Grab()
			end
		end
	end)

	hook.Add("KeyPress", "ChadFistsDrop", function(ply, key)
...
hook.Add("InitPostEntity", "ChadFistsOverwriteNSHands", function()
	weapons.Register(wep, "nut_hands")
end)