...
SWEP.MuzzleFlashEffect          = "tfa_fallout_muzzleflash_laser_rcw" -- Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
SWEP.Primary.Sound             = Sound("TFA_FALLOUT.Laser_RCW.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound     = Sound("TFA_FALLOUT.Laser_RCW.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
...
SWEP.IronSightsPos     = Vector(-2.245, 0, 0.66)
SWEP.IronSightsAng     = Vector(0.1, 0.04, 0)

--[[ SPRINTING ]]--

SWEP.RunSightsPos = Vector(2.5, 0.2, -0.5)
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_laser_rcw.mdl" -- Viewmodel path
...
SWEP.WorldModel	    = "models/weapons/tfa_fallout/w_fallout_laser_rcw.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	["R Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(-0.1, -0.3, 0.1), angle = Angle(0, 15, 0) },
	["L Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-5, -5, 0) },
...
--	["Slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -0.12), angle = Angle(0, 0, 0) },
}
