...
SWEP.Gun = ("tfa_fallout_laserpistol") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Purpose				= ""
SWEP.Instructions			= ""
SWEP.PrintName				= "Laser Pistol (microfusion cells)"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/hub/weapons/laserpistol/c_laserpistol.mdl"	-- Weapon view model
...
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/hub/weapons/laserpistol/laserpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.71, 1.521, 1.526), angle = Angle(0, 88.503, -174.749), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.Primary.Sound			= Sound("weapons/laserpistol/weapon_laserpistol1.ogg")
SWEP.Primary.RPM			= 228			-- This is in Rounds Per Minute
...
SWEP.IronSightsPos = Vector(-4.624, -9.447, 0)
