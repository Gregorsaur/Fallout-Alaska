...
SWEP.PrintName				= "5.56MM Pistol"         -- Weapon name (Shown on HUD)
...
SWEP.Primary.KickDown           = 0.350                     -- This is the maximum downwards recoil (skeet)
...
SWEP.Primary.SpreadMultiplierMax = 4.56         -- How far the spread can expand when you shoot. Example val: 2.5
SWEP.Primary.SpreadIncrement     = 1.43         -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery      = 5.90         -- How much the spread recovers, per second. Example val: 3
...
SWEP.IronSightsPos     = Vector(-3.8, -0.5, 0.8)
SWEP.IronSightsAng     = Vector(-0.55, 0.125, 0)
...
SWEP.InspectPos     = Vector(6, -9, -2.241) 
SWEP.InspectAng     = Vector(24.622, 42.915, 15.477)

--[[ VIEWMODEL ]]--

SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_556_pistol.mdl" -- Viewmodel path
...
SWEP.WorldModel	    = "models/weapons/tfa_fallout/w_fallout_556_pistol.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	...
	["muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0.35, 1, 0), angle = Angle(0, 0, 0) },
}
