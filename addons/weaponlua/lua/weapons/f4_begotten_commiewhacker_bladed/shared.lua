...
SWEP.PrintName = "Bladed Commie Whacker"
...
SWEP.BlockSound1 = Sound( "physics/plastic/plastic_box_impact_bullet3.wav" ) 
SWEP.BlockSound2 = Sound( "physics/plastic/plastic_box_impact_bullet1.wav" ) 
...
//This if shot the bullets
	...
	dmginfo:SetDamageType(DMG_CLUB)
		...
		if tr.Entity:IsPlayer() or string.find(tr.Entity:GetClass(),"npc") or string.find(tr.Entity:GetClass(),"prop_ragdoll") then
			self:EmitSound("physics/plastic/plastic_barrel_impact_bullet"..math.random(1, 3)..".wav");
...
SWEP.VElements = {
	["v_commiewhacker"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/commiewhacker.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.799, 0.518), angle = Angle(1.169, -3.507, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1} },
...
SWEP.WElements = {
	["w_commiewhacker"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/commiewhacker.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 0.518), angle = Angle(5.843, -73.637, 174.156), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1} }
}