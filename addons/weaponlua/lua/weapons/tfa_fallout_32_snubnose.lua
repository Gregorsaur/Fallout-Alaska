...
SWEP.PrintName				= "32 Snubnose"		      -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound                 = Sound("TFA_Fallout.32_Snubnose.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound         = nil     -- This is the sound of the weapon, when silenced.

SWEP.Primary.PenetrationMultiplier = 1       -- Change the amount of something this gun can penetrate through
SWEP.Primary.Damage                = 6       -- Damage, in standard damage points.
...
SWEP.Primary.KickHorizontal  = 0.65     -- This is the maximum sideways recoil (no real term)
...
SWEP.IronSightsPos = Vector(-1.83, 0, 0.44)
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_32_snubnose.mdl" -- Viewmodel path
...
SWEP.WorldModel		= "models/weapons/tfa_fallout/w_fallout_32_snubnose.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	["Weapon"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0.15, 0.1, 0.25), angle = Angle(0, 0, 0) },
	["Speed_Loader"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0.15, 0.1, 0.25), angle = Angle(0, 0, 0) },
--	["Plunger"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0.15, 0.1, 0.25), angle = Angle(0, 0, 0) },
	["Bullet_1"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0.15, 0.1, 0.25), angle = Angle(0, 0, 0) },
	["Bullet_2"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0.15, 0.1, 0.25), angle = Angle(0, 0, 0) },
	["Bullet_3"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0.15, 0.1, 0.25), angle = Angle(0, 0, 0) },
	["Bullet_4"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0.15, 0.1, 0.25), angle = Angle(0, 0, 0) },
	["Bullet_5"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0.15, 0.1, 0.25), angle = Angle(0, 0, 0) },
