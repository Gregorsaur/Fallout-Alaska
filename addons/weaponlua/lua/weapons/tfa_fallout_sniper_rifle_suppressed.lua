...
SWEP.PrintName				= "Suppressed Sniper Rifle" -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound          = Sound("weapons/fallout_new_vegas/sniper_rifle_suppressed/wpn_sniperriflemod.wav") -- This is the sound of the weapon, when you shoot.

SWEP.Primary.PenetrationMultiplier = 1.3       -- Change the amount of something this gun can penetrate through
...
SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_sniper_rifle_suppressed.mdl" -- Viewmodel path
...
SWEP.WorldModel	    = "models/weapons/tfa_fallout/w_fallout_sniper_rifle_suppressed.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	["tag_flash"] = { scale = Vector(1, 1, 1), pos = Vector(10, 0, 0), angle = Angle(0, 0, 0) },
