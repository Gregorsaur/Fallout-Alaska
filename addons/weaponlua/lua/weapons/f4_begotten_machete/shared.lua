...
//This if shot the bullets
	...
	if ( tr.Hit ) then
		...
		bullet.Damage = math.random( 25, 25 )
...
SWEP.VElements = {
	...
	["v_machete"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/machete.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 1.6, 4.599), angle = Angle(1.169, -92.338, -169.482), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_machete"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/machete.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.4, 0.518, 7), angle = Angle(3.506, -104.027, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}