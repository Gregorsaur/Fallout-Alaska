...
SWEP.PrintName = "Spiked Walking Cane"
...
SWEP.VElements = {
	...
	["v_walkingcane_spiked"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/walkingcane.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.752, 2.596, -19.222), angle = Angle(1.169, -94.676, 10.519), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 3} }
}


SWEP.WElements = {
	["w_walkingcane_spiked"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/walkingcane.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.4, 2.596, -22.338), angle = Angle(3.506, -104.027, 1.169), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 3} }
}