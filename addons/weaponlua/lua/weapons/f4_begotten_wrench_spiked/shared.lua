...
SWEP.VElements = {
	...
	["v_wrench_spiked"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/pipewrench.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.4, 1.557, 5), angle = Angle(1.169, -94.676, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 8} }
}

SWEP.WElements = {
	["w_wrench_spiked"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/pipewrench.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, 0.518, 4.675), angle = Angle(8.182, -68.961, -169.482), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 8} }
}