...
SWEP.Category				= "Fallout | Weapons (5.56mm Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Handmade Rifle"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("hmarshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_hmar.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_hmar.mdl" -- Weapon world model path
...
--Vector(6.548, 0.72, -2.031), angle = Angle(-6.933, 0.943, 180) hmar 
...
SWEP.IronSightsAng = Vector(0.347, -2.199, 0.75)
