SWEP.PrintName = "FM Automatic Rifle"
...
SWEP.BlowbackBoneMods = {
	...
	["Weapon_Thing"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 45, 0) }	
}
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/fml/fallout/c_autorif.mdl"
...
SWEP.ViewModelBoneMods = {
	...
	["A_Optic"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 2), angle = Angle(0, 180, 0) },
}

SWEP.WElements = {
	["E"] = { type = "Model", model = "models/weapons/fml/fallout/c_autorif.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.5, 3.588, -6), angle = Angle(-10, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}

SWEP.VElements = {
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(0.115, 0, -0.2), angle = Angle(0, 0, 0) },
	["sights_folded"] = { type = "Model", model = "models/weapons/fml/fallout/c_autorif.mdl", bone = "Weapon_Main", rel = "", pos = Vector(2.411, -5.301, -6.049), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1, [1] = 1} },
}

SWEP.IronSightsPos = Vector(-2.401, -2, 0.381)
...
SWEP.Primary.IronAccuracy = .00145 -- Ironsight accuracy, should be the same for shotguns
