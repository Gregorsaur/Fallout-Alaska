...
SWEP.Gun = ("weapon_tylerspice_hunting_rifle_supremenetworks") 
...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/huntingrifle.mdl", bone = "v_weapon.scout_Parent", rel = "", pos = Vector(-0.077, 2.552, 7.722), angle = Angle(0, 0, -90.54), size = Vector(1.092, 1.092, 1.092), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/huntingrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.235, 0.885, 2.993), angle = Angle(0, 90.384, -175.874), size = Vector(1.092, 1.092, 1.092), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
