...
SWEP.PrintName				= "Recharger Fhyperbreeder" -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound             = Sound("weapons/fallout_new_vegas/recharger_pistol/Wpn_mfbreeder_fire2d_01.wav")            -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Spread              = .032         -- This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.IronSightsPos     = Vector(-2.1105, 0, 0.25)
SWEP.IronSightsAng     = Vector(-2.4, -0.02, 0)

--[[ SPRINTING ]]--

SWEP.RunSightsPos   = Vector(1.35, -9, -7)
...
SWEP.ViewModel				= "models/Fallout/fonv/rechargerpistol/c_fallout_recharger_fhyperbreeder.mdl"	-- Weapon view model

SWEP.VMPos          = Vector(0, -1, -0.3)
...
SWEP.WorldModel				= "models/Fallout/fonv/rechargerpistol/w_fallout_fhyperbreeder.mdl"	-- Weapon view model
...
SWEP.ViewModelBoneMods = {
	...
	["R Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(-0.25, 0, 0), angle = Angle(0, 0, 0) },
	["A_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, -5.35, 0.5), angle = Angle(0, 0, 0) },
}
SWEP.VElements = {}
SWEP.WElements = {}
