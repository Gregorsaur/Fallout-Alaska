...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserpistol.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.112, -2.238, 0.279), angle = Angle(1.023, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.858, 2.269, 1.748), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Energy Weapons/laserpistol.mdl"
