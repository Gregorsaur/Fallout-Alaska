...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/nukabreaker.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(4.091, -0.456, -15.455), angle = Angle(4.218, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/nukabreaker.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.801, 1.277, 15.753), angle = Angle(180, -104.616, 0.155), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.MissSound 				= Sound("weapons/props_dane/nukabreaker/swing0.wav")
SWEP.WallSound 				= Sound("weapons/props_dane/nukabreaker/impact0.wav")
