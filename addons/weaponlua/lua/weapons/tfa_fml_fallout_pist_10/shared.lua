...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/fml/fallout/c_10mm.mdl"
SWEP.WorldModel = "models/weapons/w_smg1.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["Weapon_Shell"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 135, 0) },	
	["Weapon_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.5, 2), angle = Angle(-90, 0, 0) },	
	["A_Optic"] = { scale = Vector(1, 1, 1), pos = Vector(-0.15, 0, 0), angle = Angle(0, 180, 0) },
}

SWEP.WElements = {
	["E"] = { type = "Model", model = "models/weapons/fml/fallout/c_10mm.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7, 3.588, -3), angle = Angle(-10, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}

SWEP.VElements = {
	["Mag_Fix"] = { type = "Model", model = "models/props_phx/construct/plastic/plastic_panel1x1.mdl", bone = "Weapon_Mag", rel = "", pos = Vector(-0.195, -1.3, -0.201), angle = Angle(0, 0, 7.764), size = Vector(0.014, 0.074, 0.014), color = Color(0, 0, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.IronSightsPos = Vector(-2.715, -3, 0.875)
SWEP.IronSightsAng = Vector(-0.866, 0, 0)
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(1.559, -2, -1.5)
