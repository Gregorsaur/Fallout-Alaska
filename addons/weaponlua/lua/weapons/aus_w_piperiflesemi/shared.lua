...
SWEP.Category				= "Fallout | Weapons (.38 Rounds)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Pipe Rifle Semi-Automatic"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("piperifleshoot") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Ammo = "CombineCannon" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_piperiflesemi.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_piperiflesemi.mdl" -- Weapon world model path
...
--Vector(13.041, 0.666, -5.018), angle = Angle(-9.063, 4.235, 180) pipe
...
SWEP.IronSightsPos = Vector(-6.401, -5.628, 2)
SWEP.IronSightsAng = Vector(0.407, -2.376, 0.961)
