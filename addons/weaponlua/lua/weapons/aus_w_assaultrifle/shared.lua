...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("mgshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_machinegun.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_machinegun.mdl" -- Weapon world model path
...
--Vector(7.763, 0.782, -1.926), angle = Angle(-11.981, -6.567, 180) mg
...
SWEP.IronSightsPos = Vector(-4.961, 0, 0.119)
SWEP.IronSightsAng = Vector(-0.138, -2.131, 0)
