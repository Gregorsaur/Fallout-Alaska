...
SWEP.PrintName				= "Thompson (556 ammo)"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_waw_tommy_reg.mdl"	-- Weapon view model
...
SWEP.SightsPos = Vector(-2.975, 0, 1.559)
SWEP.SightsAng = Vector(-0.101, -0.201, 0)
SWEP.RunSightsPos = Vector (1.44, 0, -0.681)
SWEP.RunSightsAng = Vector (-18.101, 37.299, -24.5)
SWEP.InspectPos = Vector(7.239, 0, -0.921)
SWEP.InspectAng = Vector(6.4, 20.6, 12.3)
