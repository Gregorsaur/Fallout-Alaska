...
SWEP.PrintName				= "Combat Rifle"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("combatrifleshoot") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/illusion/fwp/v_combatrifle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/illusion/fwp/w_combatrifle.mdl" -- Weapon world model path
...
--Vector(5.565, 0.961, -1.326), angle = Angle(-14.244, 3.451, -180) cr
