...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/cattleprod.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(4.081, -0.992, -9.421), angle = Angle(0.6, 105.4, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
