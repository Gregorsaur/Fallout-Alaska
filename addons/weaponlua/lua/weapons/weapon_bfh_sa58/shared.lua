...
SWEP.Gun = ("weapon_bfh_sa58") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "SA-58 OSW"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_bfh_sa58.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_bfh_sa58.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("sa58.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-2.231, -1.4, 0.759)
SWEP.SightsAng = Vector(-0.101, 0, 0)
SWEP.RunSightsPos = Vector (0.36, 0, -2.441)
SWEP.RunSightsAng = Vector (-11.4, 39.099, -33.701)
SWEP.InspectPos = Vector(1.759, 0, -3.6)
SWEP.InspectAng = Vector(12, 13.899, 0)
