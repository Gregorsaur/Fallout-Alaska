...
SWEP.Category				= "Fallout | Weapons (Plasma Cartridge)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Plasma Rifle"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage = 44 -- Damage, in standard damage points.
...
SWEP.Primary.Automatic = false -- Automatic/Semi Autos
