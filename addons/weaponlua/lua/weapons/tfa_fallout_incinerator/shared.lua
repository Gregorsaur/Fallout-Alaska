...
SWEP.Category				= "TFA Fallout:Alaska - Flame Weapons" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Incinerator"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage = 210 -- Damage, in standard damage points.
...
SWEP.Primary.Ammo = "FlamerFuel" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--Range Related
SWEP.Primary.Range = 16 * 20 --Flame Distance
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/heavy weapons/heavyincenerator.mdl"
...
--[2] = etc.
--}
SWEP.DefaultHoldType = "physgun" -- This is how others view you carrying the weapon. Options include:
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["flamer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/heavyincenerator.mdl", bone = "Base", rel = "", pos = Vector(4.633, 17.475, -31.178), angle = Angle(0, -180, 90), size = Vector(1.074, 1.074, 1.074), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["flamer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/heavyincenerator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.665, 8.753, 15.753), angle = Angle(160.46, -80.953, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.Attachments = {
...
function SWEP:Think2( ... )
	...
	if shooting ~= self.Shooting_Old then
		if shooting then
			self:EmitSound("weapons/flamer/flamer_fire_lp.wav")
	...
	if shooting then
		if self.NextIdleSound and CurTime() > self.NextIdleSound then
			self:EmitSound("weapons/flamer/flamer_fire_lp.wav")
			self.NextIdleSound = CurTime() + SoundDuration( "weapons/flamer/flamer_fire_lp.wav" ) - 0.1
		end
	end
...
--[[
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/servius/starwars/cwa/flamethrower.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.4, 0.5, -0.201), angle = Angle(-90, 0, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/servius/starwars/cwa/flamethrower.mdl", bone = "minigun", rel = "", pos = Vector(1.1, 7.4, -7.301), angle = Angle(0, 90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.HoldType = "crossbow"
SWEP.ViewModelFOV = 60.70351758794
