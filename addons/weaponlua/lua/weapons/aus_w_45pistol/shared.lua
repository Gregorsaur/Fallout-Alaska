SWEP.PrintName = "45 Pistol"
SWEP.Author = "Fleshy Mammal"
SWEP.Contact = ""
SWEP.Purpose = ""
SWEP.Instructions = ""

SWEP.Category = "Fallout | Weapons (.45 Rounds)"
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/fml/fallout/c_45_pist.mdl"
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_R_Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0.444, 0, 0), angle = Angle(0, 0, 0) }
...
SWEP.IronSightsPos = Vector(-2.59, -1.5, 0.953)
SWEP.IronSightsAng = Vector(0.349, 0, 0)
...
SWEP.Attachments = {
	...
	[7] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds"}, order = 2 },
