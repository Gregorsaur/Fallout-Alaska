...
SWEP.Primary.Sound             = Sound("TFA_FALLOUT.Service_Rifle.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound     = Sound("TFA_FALLOUT.Service_Rifle.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
...
SWEP.IronSightsPos     = Vector(-1.445, 0, -0.12)
...
SWEP.InspectPos     = Vector(6, -5, -2) 
SWEP.InspectAng     = Vector(24.622, 42.915, 15.477)

--[[ VIEWMODEL ]]--

SWEP.ViewModel		= "models/weapons/tfa_fallout/c_fallout_service_rifle.mdl" -- Viewmodel path
...
SWEP.WorldModel	    = "models/weapons/tfa_fallout/w_fallout_service_rifle.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	["M16_HotBod"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["m16_magazine"] = { scale = Vector(1.05, 1.05, 1.1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["L UpperArm"] = { scale = Vector(0.95, 0.95, 0.95), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	...
	["A_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, -2.25, 0), angle = Angle(0, 0, 0) },
	["A_Eject"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.5, -0.15), angle = Angle(0, 0, 0) },
}
