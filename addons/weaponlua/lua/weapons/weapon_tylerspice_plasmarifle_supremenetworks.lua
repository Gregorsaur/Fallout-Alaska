SWEP.Gun = ("weapon_tylerspice_plasmarifle_supremenetworks") 
...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/plasma weapons/plasmarifle.mdl", bone = "v_weapon.m4_Parent", rel = "", pos = Vector(0.589, 2.043, 7.379), angle = Angle(0, 0, -84.445), size = Vector(1.166, 1.166, 1.166), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/plasma weapons/plasmarifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.194, 0.762, 2.46), angle = Angle(0, 90, -173.06), size = Vector(1.166, 1.166, 1.166), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
