...
CreateMaterial( "phoenix_storms/wood", "VertexLitGeneric", {
...
local phoenix_stormswood = Material( "phoenix_storms/wood" )
phoenix_stormswood:SetTexture( "$basetexture", "color/white" )
...
hook.Add("HUDPaint", "WAYSHRINE_CLIENT", function()
    ...
    if dev then
        ...
        surface.SetDrawColor(Color(100,25,25))
        draw.NoTexture()
        surface.DrawRect(v.x - 4, v.y - 4, 32, 32)
    ...
    for c, ch in pairs(nzWAYSHRINES:GetWayShrines(0)) do
