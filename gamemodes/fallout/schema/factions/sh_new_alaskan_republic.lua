FACTION.name = "Alaskan Militia"
FACTION.desc = " A group of NCR Defectors who fled north with a group of Vigilantes to escape the grasp of the NCR, and protect common wastelanders."
